...
public class playerEarth extends playerTemplate {
    ...
    public playerEarth(int x, int y, worldTemplate currentWorld, attackTemplate attack, attackTemplate specialAttack) {
        super(x,y,
        1,abilityAttacks.EARTH_ELEMENT, 25, 100, 1000, 100, 3, 1,
        100, currentWorld, "playerEarthSprites", attack, "Earth Guy", 
        2, 10, 200, 5000, 10, 45, 1, "Tornado", specialAttack);
    }
