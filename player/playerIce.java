...
public class playerIce extends playerTemplate {
    ...
    public playerIce(int x, int y, worldTemplate currentWorld, attackTemplate attack, attackTemplate specialAttack) {
        super(x,y,
        0,abilityAttacks.ICE_ELEMENT, 50, 100, 500, 100, 1, 1,
        100, currentWorld, "playerIceSprites", attack, "Ice Guy", 
        3, 100, 200, 2000, 20, 3, 2, "HUGE Icicle", specialAttack);
    }
