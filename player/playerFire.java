...
public class playerFire extends playerTemplate {
    ...
    public playerFire(int x, int y, worldTemplate currentWorld, attackTemplate attack, attackTemplate specialAttack) {
        super(x,y,
        0,abilityAttacks.FIRE_ELEMENT, 50, 300, 500, 100, 1, 1,
        100, currentWorld, "playerFireSprites",attack, "Fire Guy",
        1, 30, 150, 5000, 20, 3, 2, "Huge Fireball", specialAttack);
    }
