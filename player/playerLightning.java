...
public class playerLightning extends playerTemplate {
    ...
    public playerLightning(int x, int y, worldTemplate currentWorld, attackTemplate attack) {
        super(x, y, 0, abilityAttacks.LIGHTNING_ELEMENT, 10, 1000, 1000, 100, 5, 2, 100, currentWorld, "playerLightningSprites",attack, "Lightning Guy", 5000, 1, "Tripple Strike", 10);
    }
